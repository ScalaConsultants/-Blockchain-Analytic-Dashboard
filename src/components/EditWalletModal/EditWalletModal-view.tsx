...
const EditWalletModalView = ({ open, handleOpen, handleClose, handleUpdate, handleChange, id, address, description }: ViewProps) => {
    ...
    >
      <Fade in={open}>
        <div className={classesPaper}>
          ...
          <Divider light={true} className={classes.background} />
          ...
          <Grid container direction="row" justify="center" alignItems="center" spacing={2} className={classes.marginTop15}>
            <Grid item>
              <Button 
                variant="outlined" 
                color="inherit" 
